...
<title>Insureity Portal | Create Business Property</title>
<link rel="stylesheet"
...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<h1>Create Business Properties</h1>
			</div>
		</div>
		<br>
		...
		<div class="form-group">
			<form action="createproperty" name="Property Form" method="post"
				...
				<div class="row">
					<div class="col-lg-6 col-sm-12">
						<label for="buildingAge">Building Age</label> <input type="number"
							class="form-control" id="buildingAge" name="buildingAge" required>
				...
				<div class="row">
					<div class="col-lg-6 col-sm-12">
						<label for="usefulLife">Useful Life</label> <input type="number"
							class="form-control" id="usefulLife" name="usefulLife" required>
				...
				<div class="row">
					<div class="col-lg-6 col-sm-12">
						<label for="bid">Business Id</label> <input type="text"
							class="form-control" id="bid" name="bid" value="${bId}"
							readonly="readonly">
					</div>
