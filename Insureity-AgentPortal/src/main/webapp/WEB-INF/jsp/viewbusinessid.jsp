...
<title>Insureity Portal | View Business By Id</title>
<meta name="viewport"
...
<body>
	...
	<h2 class="idheader">View Business</h2>
	<br>
	<br>
	<form action="viewbusiness" method="get" class="form">
		Enter Consumer Id<input type="text" class="form-control"
			placeholder="C01" id="cId" name="cId"><br />
