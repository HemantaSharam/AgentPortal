...
<title>Insureity Portal | Create Consumer Business</title>
<link rel="stylesheet"
...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<h1>Create Consumer Business</h1>
			</div>
		</div>
		<br>
		...
		<div class="form-group">
			<form action="createbusiness" method="post" name="Business Form"
				...
				<div class="row">
					<div class="col-lg-6 col-sm-12">
						<label for="businessType">Business Type (Sector)</label> <input
				...
				<div class="row">
					<div class="col-lg-6 col-sm-12">
						<label for="turnOver">Turnover</label> <input type="number"
							class="form-control" id="turnOver" name="turnOver" required>
				...
				<div class="row">
					<div class="col-lg-6 col-sm-12">
						<label for="cid">Consumer Id</label> <input type="text"
							class="form-control" id="cid" name="cid" placeholder="C01"
							required>
					</div>
				</div>
				<br>
